 ...
 *
 * Every console call in src/sync goes through this. There are no others.
 */
 ...
 *
 * A write outcome (#12) lands in write_log and is read by a model — two places
 * the credential must not reach either, and neither one a logger covers.
 */
