 ...
 * (lswith/lswith.io#138). Keeping it that way is what confines the
 * app-specific password to one worker.
 *
 ...
 * via `createMcpHandler`, with `search_messages` — lands in
 * lswith/lswith.io#133, and Cloudflare Access gates it in #136.
 *
