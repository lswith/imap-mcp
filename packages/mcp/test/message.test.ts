...
import { BAD_ID, getMessage, MAX_BODY_CHARS, NOT_FOUND, STALE } from "../src/message";
...
describe("getMessage", () => {
  ...
  describe("without a network", () => {
    ...
    // this package cannot import an IMAP client at all; this is the
    // behavioural half. `cloudflare:sockets` is not reachable from here, and
    // `fetch` is the only other way out of the isolate.
    beforeEach(() => {
      vi.stubGlobal("fetch", () => {
